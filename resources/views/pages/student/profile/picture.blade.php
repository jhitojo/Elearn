        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    @else
                        <img src="{{ asset('/dash/dist/img/avatar04.png') }}" class="img-circle elevation-2" alt="User Image">
                    @endif
                        </div>

                <form role="form" action="/Student/Profile/Picture" method="post" enctype="multipart/form-data">
                    @csrf
