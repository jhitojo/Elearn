                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      <div class="text-center">
                            ...
                            @endif -->
                            @if($user->avatar)
                                <img class="profile-user-img img-fluid img-circle" src="/dash/dist/img/{{ $user->avatar }}" class="img-circle elevation-2" alt="User profile picture">
                            @else
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('/dash/dist/img/avatar04.png') }}" class="img-circle elevation-2" alt="User profile picture">
                            @endif
                        </div>
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Student/Profile/{{ $user->id }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="nim" type="text" class="form-control" placeholder="NIM" value="{{ $user->nim }}">
                                            @if($errors->has('nim'))
                                                <div class="text-danger">
                                                    {{ $errors->first('nim')}}
                                                </div>
