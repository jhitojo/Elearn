...
@section('title', 'Admin - Dosen Profile Page Manager')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <h5><strong>Profile Page Dosen</strong></h5>
                    </div>
                <div class="col-sm-6">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      <div class="text-center">
                            @if($teacher->avatar)
                                <img class="profile-user-img img-fluid img-circle" src="/dash/dist/img/{{ $teacher->avatar }}" alt="User profile picture">
                            @else
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('/dash/dist/img/avatar3.png') }}" alt="User profile picture">
                            @endif
                        </div>
