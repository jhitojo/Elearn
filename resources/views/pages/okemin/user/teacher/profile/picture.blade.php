            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-user-image">
                        @if($teacher->avatar)
                            <img class="img-circle mx-auto d-block" width="200px"  src="/dash/dist/img/{{ $teacher->avatar }}" alt="User Avatar">
                        @else
                            <img class="img-circle mx-auto d-block" width="200px"  src="{{ asset('/dash/dist/img/avatar3.png') }}" alt="User Avatar">
                        @endif
                    </div>
