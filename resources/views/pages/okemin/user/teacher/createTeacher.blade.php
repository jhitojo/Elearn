...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <h5><strong>Create Dosen</strong></h5>
                    </div>
                <div class="col-sm-6">
            ...
            <div class="card card-primary">
                     ...
                     <div class="row">
                            @if ($message = Session::get('success'))
                                <div class="alert alert-success alert-block">
                                    ...
                                    <p>Lihat di Sidebar->User Manager->Dosen Manager</p>
                                </div>
                            @endif
                    </div>
                ...
                <form role="form" action="/Okemin/User/Teacher/Create/Send" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="name" type="name" class="form-control" id="input1" placeholder="Nama Dosen">
                            @if($errors->has('name'))
