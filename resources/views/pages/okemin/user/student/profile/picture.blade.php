            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-user-image">
                        @if($student->avatar)
                            <img class="img-circle mx-auto d-block" width="200px"  src="/dash/dist/img/{{ $student->avatar }}" alt="User Avatar">
                        @else
                            <img class="img-circle mx-auto d-block" width="200px"  src="{{ asset('/dash/dist/img/avatar04.png') }}" alt="User Avatar">
                        @endif
                    </div>

                <form role="form" action="/Okemin/User/Student/Profile/Picture/Send/{{ $student->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>{{$student->name}}'s Photo</label>
                        <br>
