...
@section('title', 'Admin - Mahasiswa Profile Page Manager')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><strong>Profile Page Mahasiswa</strong></h5>
                    </div>
                <div class="col-sm-6">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      <div class="text-center">
                            @if($student->avatar)
                                <img class="profile-user-img img-fluid img-circle" src="/dash/dist/img/{{ $student->avatar }}" alt="User profile picture">
                            @else
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('/dash/dist/img/avatar04.png') }}" alt="User profile picture">
                            @endif
                        </div>
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Okemin/User/Student/Profile/Send/{{ $student->id }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="nim" type="text" class="form-control" placeholder="NIM" value="{{ $student->nim }}">
                                            @if($errors->has('nim'))
                                                <div class="text-danger">
                                                    {{ $errors->first('nim')}}
                                                </div>
