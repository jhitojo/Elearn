...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5><strong>Create Mahasiswa</strong></h5>
                    </div>
                <div class="col-sm-6">
            ...
            <div class="card card-primary">
                     ...
                     <div class="row">
                            @if ($message = Session::get('success'))
                                <div class="alert alert-success alert-block">
                                    ...
                                    <p>Lihat di Sidebar->User Manager->Mahasiswa Manager</p>
                                </div>
                            @endif
                    </div>
                ...
                <form role="form" action="/Okemin/User/Student/Create/Send" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="name" type="name" class="form-control" id="input1" placeholder="Nama Mahasiswa">
                            @if($errors->has('name'))
                    ...
                    <h5>DATA AKADEMIK</h5>
                    <div class="form-group row">
                        <label for="input8" class="col-sm-2 col-form-label">NIM*</label>
                        <div class="col-sm-10">
                          <input name="nim" type="text" class="form-control" id="input8" placeholder="NIM">
                            @if($errors->has('nim'))
                                <div class="text-danger">
                                    {{ $errors->first('nim')}}
                                </div>
