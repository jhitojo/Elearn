                    ...
                    <tbody>
                      @foreach($matkuls as $matkul )
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-block bg-gradient-primary btn-xs" href="/Okemin/Matkul/Edit/{{ $matkul->id }}">Edit</a>
                                <a type="button" class="btn btn-block bg-gradient-danger btn-xs" href="/Okemin/Matkul/Delete/{{ $matkul->id }}">Delete</a>
                            </td>
                        </tr>
                      @endforeach
                    </tbody>
