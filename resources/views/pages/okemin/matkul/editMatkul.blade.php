...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <h5><strong>Edit Mata Kuliah</strong></h5>
                    </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form role="form" action="/Okemin/Matkul/Update/{{ $matkul->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label for="input1" class="col-sm-2 col-form-label">Nama Mata Kuliah</label>
                        <div class="col-sm-10">
                          <input value="{{ $matkul->nama_matkul }}" name="nama_matkul" type="name" class="form-control" id="input1" placeholder="Nama Mata Kuliah">
