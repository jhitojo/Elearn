            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-user-image">
                        @if($user->avatar)
                            <img class="img-circle mx-auto d-block" width="200px"  src="/dash/dist/img/{{ $user->avatar }}" alt="User Avatar">
                        @else
                            <img class="img-circle mx-auto d-block" width="200px"  src="{{ asset('dash/dist/img/avatar5.png') }}" alt="User Avatar">
                        @endif
                    </div>
