...
class TeacherController extends Controller
{
    ...
    public function showCreateMateri()
    {
        ...
        $matkul = mataKuliah::all(); // Untuk Show List matkul - Select
        $kelas = Kelas::all(); // Untuk Show List Kelas - Select
        return view('pages.teacher.materi.createMateri', compact('user', 'matkul', 'kelas') );
    }
    ...
    public function searchMateri(Request $request)
	{
        ...
        $search = Materi::where('matkul','like',"%".$search."%")
    ...
    public function editMateri($id)
    {
        ...
        return view('pages.teacher.materi.editMateri', compact('user', 'materi', 'matkul', 'kelas'));
    }
    ...
    public function showCreateExercise()
    {
        ...
        $matkul = mataKuliah::all(); // Untuk Show List matkul - Select
        $kelas = Kelas::all(); // Untuk Show List Kelas - Select
        return view('pages.teacher.exercise.createExercise', compact('user', 'matkul', 'kelas') );
    }
    ...
    public function searchExercise(Request $request)
	{
		...
		$search = $request->table_search;
    		...
    		// mengambil data dari table materi sesuai pencarian data
        $search = Exercise::where('matkul','like',"%".$search."%")
                            ->orWhere('kelas','like',"%".$search."%")
    ...
    public function editExercise($id)
    {
        ...
        return view('pages.teacher.exercise.editExercise', compact('user', 'exercise', 'matkul', 'kelas'));
    }
    ...
    public function updateExercise(Request $request, $id)
    {
        ...
        $exercise = Exercise::findOrFail($id);
        $exercise->matkul = $request->matkul;
