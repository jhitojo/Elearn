...
class AdminController extends Controller
{
    ...
    /*
     * This is For Show Search Matkul
     *
     */
    ...
    /* ------------------------------------------ MATKULSECTION ----------------------------------- */
    /*
     * This is For Mata Kuliah
     *
     */
    public function showCreateMatkul()
    {
        $user = Auth::user(); // Untuk Photo Profile
        return view('pages.okemin.matkul.createMatkul', compact('user', $user));
    }
     ...
     *
     */
    public function showMatkulList(Request $request)
    {
        $user = Auth::user(); // Untuk Photo Profile
        $matkuls = mataKuliah::get(); // Show, atau Get All "Materi"
        return view('pages.okemin.matkul.showMatkul', compact('matkuls', 'user') );
    }
    ...
    public function searchMatkul(Request $request)
	{
		...
		$search = $request->table_search;
    		...
    		// mengambil data dari table materi sesuai pencarian data
        $search = mataKuliah::where('nama_matkul','like',"%".$search."%")
                            ->get();

    		// mengirim data materi ke view index
		return view('pages.okemin.matkul.showMatkulFiltered', compact('search', 'user') );

    }

    /*
     * This is For Show Update Matkul
     *
     */
    public function editMatkul($id)
    {
        ...
        return view('pages.okemin.matkul.editMatkul', compact('user', 'matkul',));
    }
    ...
    public function updateMatkul(Request $request, $id)
    {
        ...
        return back()->with('success','Mata Kuliah Berhasil diUpdate/diEdit.');
    }

    /*
     * This is For Delete Matkul
     * SUCCESS alertnya blum ada
     */
