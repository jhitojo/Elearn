...
class StudentController extends Controller
{
    ...
    /* --------------------------------------------- MATERI SECTION --------------------------------- */
    /**
     * Show Matkul sesuai dengan kelas
     *
     */
    public function showMatkul()
    {
    	...
    	return view('pages.student.materi.showMatkul', compact('user', 'matkuls'));
    }



    /**
     * Show Materi-Materi sesuai dengan kelas dan matkul
     *
     */
    public function showMateriList($id)
    {
        ...
        $materis = Materi::where('kelas', $user->kelas)->where('matkul', $matkul->nama_matkul)->get();

    	return view('pages.student.materi.showMateriList', compact('user', 'matkul', 'materis'));
    }
