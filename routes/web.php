 ...
 */
// Create Matkul - Admin
Route::get('/Okemin/Matkul/Create', 'AdminController@showCreateMatkul')->middleware('role:Admin');
Route::post('/Okemin/Matkul/Create/Send', 'AdminController@createMatkul')->middleware('role:Admin');
// Show List Matkul - Admin
Route::get('/Okemin/Matkul/List', 'AdminController@showMatkulList')->middleware('role:Admin');
// Search Matkul - Admin
Route::get('/Okemin/Matkul/List/Search', 'AdminController@searchMatkul')->middleware('role:Admin');
// Edit Matkul - Okemin
Route::get('/Okemin/Matkul/Edit/{id}', 'AdminController@editMatkul')->middleware('role:Admin');
Route::put('/Okemin/Matkul/Update/{id}', 'AdminController@updateMatkul')->middleware('role:Admin');
// Delete Matkul - Okemin
Route::get('/Okemin/Matkul/Delete/{id}', 'AdminController@deleteMatkul')->middleware('role:Admin');
 ...
 *
 */
Route::get('/Student/Materi/Matkul', 'StudentController@showMatkul')->middleware('role:Student');
